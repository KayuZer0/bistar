...
export default {
    ...
    callback: async ({ channel, interaction, args }) => {
        ...
        const embed = new MessageEmbed()
            ...
            .addField(`${(await ticketschema.findOne({ 'id': 0 }))?.vanity_name} (ID: 0)`, `ㅤ ↳ **Pret:** ${(await ticketschema.findOne({ 'id': 0 }))?.shop_price} ${serverDbDoc.bistar_emoji} \nㅤ ↳ **Info:** ${(await ticketschema.findOne({ 'id': 0 }))?.info} \nㅤ ↳ **Usage:** ${(await ticketschema.findOne({ 'id': 0 }))?.usage}`, false)
            .addField(`${(await ticketschema.findOne({ 'id': 1 }))?.vanity_name} (ID: 1)`, `ㅤ ↳ **Pret:** ${(await ticketschema.findOne({ 'id': 1 }))?.shop_price} ${serverDbDoc.bistar_emoji} \nㅤ ↳ **Info:** ${(await ticketschema.findOne({ 'id': 1 }))?.info} \nㅤ ↳ **Usage:** ${(await ticketschema.findOne({ 'id': 1 }))?.usage}`, false)
            .addField(`${(await ticketschema.findOne({ 'id': 2 }))?.vanity_name} (ID: 2)`, `ㅤ ↳ **Pret:** ${(await ticketschema.findOne({ 'id': 2 }))?.shop_price} ${serverDbDoc.bistar_emoji} \nㅤ ↳ **Info:** ${(await ticketschema.findOne({ 'id': 2 }))?.info} \nㅤ ↳ **Usage:** ${(await ticketschema.findOne({ 'id': 2 }))?.usage}`, false)
            .addField(`${(await ticketschema.findOne({ 'id': 3 }))?.vanity_name} (ID: 3)`, `ㅤ ↳ **Pret:** ${(await ticketschema.findOne({ 'id': 3 }))?.shop_price} ${serverDbDoc.bistar_emoji} \nㅤ ↳ **Info:** ${(await ticketschema.findOne({ 'id': 3 }))?.info} \nㅤ ↳ **Usage:** ${(await ticketschema.findOne({ 'id': 3 }))?.usage}`, false)
            .addField(`${(await ticketschema.findOne({ 'id': 4 }))?.vanity_name} (ID: 4)`, `ㅤ ↳ **Pret:** ${(await ticketschema.findOne({ 'id': 4 }))?.shop_price} ${serverDbDoc.bistar_emoji} \nㅤ ↳ **Info:** ${(await ticketschema.findOne({ 'id': 4 }))?.info} \nㅤ ↳ **Usage:** ${(await ticketschema.findOne({ 'id': 4 }))?.usage}`, false)
            .addField(`${(await ticketschema.findOne({ 'id': 5 }))?.vanity_name} (ID: 5)`, `ㅤ ↳ **Pret:** ${(await ticketschema.findOne({ 'id': 5 }))?.shop_price} ${serverDbDoc.bistar_emoji} \nㅤ ↳ **Info:** ${(await ticketschema.findOne({ 'id': 5 }))?.info} \nㅤ ↳ **Usage:** ${(await ticketschema.findOne({ 'id': 5 }))?.usage}`, false)
            .addField(`${(await ticketschema.findOne({ 'id': 6 }))?.vanity_name} (ID: 6)`, `ㅤ ↳ **Pret:** ${(await ticketschema.findOne({ 'id': 6 }))?.shop_price} ${serverDbDoc.bistar_emoji} \nㅤ ↳ **Info:** ${(await ticketschema.findOne({ 'id': 6 }))?.info} \nㅤ ↳ **Usage:** ${(await ticketschema.findOne({ 'id': 6 }))?.usage}`, false)
